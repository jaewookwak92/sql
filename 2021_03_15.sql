...
-- 결국 이 뜻은 NOT(mgr = 7698, mgr = 7839, mgr = NULL);
--              =!(mgr = 7698, mgr = 7839, mgr = NULL);
--              mgr != 7698 AND mgr != 7839 AND mgr != NULL -- mgr != NULL이 부분이 항상 거짓이기때문에 값이 안나옴.
--              TRUE FALSE 의미가 없음.
